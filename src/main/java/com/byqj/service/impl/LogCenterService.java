...
public class LogCenterService {
     ...
     * 设置日志类型为:系统类型
     */
    public void setLogTypeIsSystem() {
        this.setLogType(LogConstant.LOG_LOG_TYPE_SYSTEM);
    }

    /**
     * 设置日志类型为:项目类型
     */
    public void setLogTypeIsProject() {
        this.setLogType(LogConstant.LOG_LOG_TYPE_PROJECT);
    }


    public String getLogType() {
        return this.getLogData(LogConstant.LOG_LOG_TYPE);
    }
